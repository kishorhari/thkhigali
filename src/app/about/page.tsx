    ...
    <>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "0 5%" }}>
          ...
          <p style={{ color: "#5b5b5b", fontSize: "1.05rem", maxWidth: "600px", margin: "0 auto", lineHeight: 1.7 }}>
      ...
      {/* Main content */}
      <div style={{ background: "#ffffff", padding: "80px 5%" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              >
                ...
                <span style={{ color: "#e7293c", display: "block" }}>Reimagined for India.</span>
              </h2>
              <p style={{ color: "#5b5b5b", lineHeight: 1.85, fontSize: "1rem", marginBottom: "1.2rem" }}>
              ...
              <p style={{ color: "#5b5b5b", lineHeight: 1.85, fontSize: "1rem" }}>
          ...
          <div style={{ marginBottom: "100px" }}>
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              ...
              >
                The{" "}
                <span style={{ color: "#e7293c" }}>Tikhi Gali</span> Promise
              </h2>
              <p style={{ color: "#5b5b5b", fontSize: "0.95rem" }}>Clean food. Bold taste. Every time.</p>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "24px" }} className="promise-grid">
              {[
                { icon: "🚫", title: "No Added MSG", desc: "Zero MSG across all our dishes — real flavour from real ingredients.", color: "#e7293c" },
                { icon: "🌿", title: "No Palm Oil", desc: "We use healthier oils in every preparation, every day.", color: "#27AE60" },
                { icon: "🎨", title: "No Artificial Flavours", desc: "Every dish gets its flavour from spices, not chemicals.", color: "#e7293c" },
                { icon: "👨‍🍳", title: "Chef-Less Model", desc: "Pre-cooked at our central unit, assembled fresh — consistent every single time.", color: "#e7293c" },
                { icon: "📦", title: "Dedicated Supply Chain", desc: "Centralized warehouse with stringent QA so every outlet delivers the same taste.", color: "#c0182b" },
                { icon: "📱", title: "Tech Enabled", desc: "POS software, delivery app integrations, and dashboard for business insights.", color: "#e7293c" },
              ].map((v) => (
                <div
                  key={v.title}
                  style={{
                ...
                >
                  ...
                  <h4 style={{ fontWeight: 800, fontSize: "1rem", color: "#05080c", marginBottom: "8px" }}>{v.title}</h4>
                  <p style={{ fontSize: "0.85rem", color: "#5b5b5b", lineHeight: 1.6 }}>{v.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ marginBottom: "80px" }}>
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              ...
              >
                Our{" "}
                <span style={{ color: "#e7293c" }}>Store Formats</span>
              </h2>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px", maxWidth: "700px", margin: "0 auto" }} className="formats-grid">
              {[
                ...
                >
                  {f.recommended && (
                    <div style={{ position: "absolute", top: "16px", right: "16px", background: "#e7293c", color: "#ffffff", fontSize: "0.65rem", fontWeight: 800, padding: "4px 12px", borderRadius: "20px" }}>
                      Recommended
                    </div>
                  )}
                  <div style={{ fontSize: "3rem", marginBottom: "12px" }}>{f.emoji}</div>
                  <div style={{ fontWeight: 800, fontSize: "1.3rem", color: "#05080c", marginBottom: "8px" }}>{f.name}</div>
                  <div style={{ fontSize: "0.87rem", color: "#5b5b5b", marginBottom: "16px", lineHeight: 1.5 }}>{f.desc}</div>
                  <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "2rem", fontWeight: 900, color: "#e7293c" }}>{f.investment}</div>
                  <div style={{ fontSize: "0.72rem", color: "#5b5b5b", marginTop: "4px" }}>*may vary by area</div>
                </div>
              ))}
            </div>
          </div>
          ...
          >
            <h3 style={{ fontFamily: "'Inter', sans-serif", fontSize: "2rem", fontWeight: 900, color: "#05080c", marginBottom: "1rem" }}>
              Ready to be part of the Tikhi Gali family?
            </h3>
            <p style={{ color: "#5b5b5b", marginBottom: "2rem", maxWidth: "500px", margin: "0 auto 2rem" }}>
            ...
            <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
              <Link
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: "8px",
                  background: "linear-gradient(135deg,#e7293c,#e7293c)",
                  color: "#fff",
                  padding: "14px 32px",
                  borderRadius: "50px",
                  fontWeight: 800,
